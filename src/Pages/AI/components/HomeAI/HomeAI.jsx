    ...
    <div className="ai-home">
     ...
     <h4 className="section-title">{t("aiHome.whatYouCanDo")}</h4>
      ...
      <div className="cards-grid">
        <div className="card"><span className="emoji">⚡</span> <strong>{t("aiHome.cards.instant")}</strong>
<p>{t("aiHome.cards.instantDesc")}</p>
        </div>
        <div className="card"><span className="emoji">✨</span> <strong>{t("aiHome.cards.summary")}</strong>
<p>{t("aiHome.cards.summaryDesc")}</p>   
        </div>
        <div className="card"><span className="emoji">🎯</span> <strong>{t("aiHome.cards.context")}</strong>
  <p>{t("aiHome.cards.contextDesc")}</p>
        </div>
        <div className="card"><span className="emoji">📚</span>  <strong>{t("aiHome.cards.types")}</strong>
