    ...
    <>
      ...
      <div className="features-section">
        ...
        <p className="features-subtitle">
          Designed specifically for the rigorous demands of modern higher
          education, combining community knowledge with cutting-edge AI.
        </p>
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            ...
            <h3>Smart Search</h3>
            <p>
              Quickly find exactly what you need with intelligent semantic
              search.
            </p>
          </div>
        </div>
      ...
      <div className="bbox">
        <div className="box">
          ...
          <p>
            Join the EDUPRO community today and start leveraging the power of
